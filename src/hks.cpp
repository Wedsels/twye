...
// movement
        ...
        },
        {
            ...
            "        b_[\"sprint\"] = false\n"
            "    end\n"
            "    if env(ActionDuration, ACTION_ARM_R2) > 240 and string.find(b_[\"last\"], \"Heavy.Start\") then\n"
            "        b_[\"last\"] = \"\"\n"
            "    end\n"
...
// attack speed
        {
            ...
            "            if l1rest[k] == nil or l1rest[k] > (g_FrameCount - l1clock[k]) * 1.2 then\n"
        ...
        },
        {
            ...
            "            cancelwait = l1rest[env(GetEquipWeaponCategory, HAND_RIGHT) .. l1] / 1.2\n"
            "        else\n"
            "            cancelwait = 0\n"
            "        end\n"
            "        is_Dual = TRUE\n        ExecEventAllBody(l1)"
